        ...
        <div className="grid md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <div className="flex items-center mb-6">
              ...
              <span className="text-xl font-bold">Rooster Print & Mail</span>
            </div>
            <p className="text-gray-400 mb-6 max-w-md">
              We are part of the United States Postal Service ecosystem and
              maintain the integrity of USPS rules and regulations while adding
              value to the postal mail system.
            </p>
